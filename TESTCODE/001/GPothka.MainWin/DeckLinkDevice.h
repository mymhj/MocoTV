...
public:
	...
	bool								StartCapture( bool applyDetectedInputMode);
	void								StopCapture();
...
public:
	...
	bool GetSynicSignal();
	BOOL m_SaveFrameFlag;
	IDeckLinkVideoInputFrame*  m_videoFrame;
	...
	BMDPixelFormat m_nFrameFormat;
	char*   m_pbBmpData;    // RGBÊý¾Ý
	int     m_CaptureFlag;
	int     FrameFormat;
	void*  m_FrameData;
...
private:
	...
	ULONG								m_refCount;
	CGPothkaMainWinDlg*					m_uiDelegate;
public:
	DeckLinkDeviceDiscovery(CGPothkaMainWinDlg*	 m_uiDelegate);
