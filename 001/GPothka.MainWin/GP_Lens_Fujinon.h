...
public:
	...
	CFuSerialPort* m_SerialPort = new CFuSerialPort(NULL);

	

public:

	int __stdcall InitComPort(CString  portNo, UINT  baud);
	...
	// 备    注：        
	//********************************************************************
	int __stdcall GetLensMotorZoom(WORD &ResultValue);
